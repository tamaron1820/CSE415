...
class BackgammonPlayer:
    ...
    def nickname(self):
        ...
        return "tatsuhiko and zheng ing"
    ...
    def move(self, state, die1=1, die2=6):
        ...
        if self.AlphaBeta:
            return self.alphaBeta_prune(state, 2,-10000000, 10000000, die1, die2)[1]
        else:
    ...
    def staticEval(self, state):
        ...
        R_bar=state.bar.count("R")
        W_bar=state.bar.count("W")
        bar_difference=R_bar-W_bar
        home_count_difference=White_home_count-Red_home_count
        White_out_board=state.white_off.count("W")
        Red_out_board=state.red_off.count("R")
        out_board_difference=White_out_board-Red_out_board
        Evaluation_count=pip_differnce+bar_difference+home_count_difference+out_board_difference
